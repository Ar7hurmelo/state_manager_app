...
class PokemonModel {
  ...
  PokemonModel copyWith({String? name, String? url}) {
    return PokemonModel(name: name ?? this.name, url: url ?? this.url);
  }
  ...
  factory PokemonModel.fromMap(Map<String, dynamic> map) {
    return PokemonModel(name: map['name'] as String, url: map['url'] as String);
  }
